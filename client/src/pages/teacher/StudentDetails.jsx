...
const StudentDetails = () => {
  ...
  const handleReject = async () => {
    try {
      ...
      await rejectInternship(internship._id, remarks);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border shadow-sm p-6">
        <h2 className="text-xl font-semibold mb-5">Internship Information</h2>
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <Info label="Domain" value={internship.domain?.domainName} />

          <Info label="Type" value={internship.internshipType} />

          <Info label="Mode" value={internship.externalDetails?.mode} />

          <Info label="Stipend" value={internship.externalDetails?.stipend} />

          <Info label="Status" value={internship.status} />
        </div>
      </div>
