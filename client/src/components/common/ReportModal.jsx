      ...
      <div className="w-full max-w-2xl rounded-2xl bg-white shadow-xl">
        ...
        <div className="space-y-5 p-6">
          ...
          <div>
            ...
            <p className="font-semibold">{report.student?.rollNumber}</p>
          </div>

          <div>
            <p className="text-sm text-slate-500">Department</p>

            <p className="font-semibold">{report.department?.departmentName}</p>
          </div>
          ...
          <div>
            ...
            <p className="font-semibold">{report.domain?.domainName}</p>
          </div>
          ...
          <div>
            <p className="text-sm text-slate-500">NOC Status</p>

            <p className="font-semibold">{report.noc?.status}</p>
          </div>
